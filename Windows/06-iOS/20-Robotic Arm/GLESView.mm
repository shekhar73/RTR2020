...
-(void)drawView:(id)sender 
{
    ...
    rotationMatrixZ = vmath::rotate(rotateShoulder, 0.0f, 0.0f, 1.0f);
    ...
    translateMatrix = vmath::translate(1.0f, 0.0f, 0.0f);
    rotationMatrixZ = vmath::rotate(elbowRotate, 0.0f, 0.0f, 1.0f);
...
-(void)pushMatrix:(mat4)matrix{
    ...
    if (iCOUNTER < COUNTER_STACK_MAX-1) {
        iCOUNTER++;
        STACK_M[iCOUNTER] = matrix;
    }
    else {
