...
HRESULT Initialize(void)
{
	...
	//-----------------------------------------------------------------------------------------
		...
		gpID3D11DeviceContext->Unmap(gpID3D11Buffer_VertexBuffer_Position, 0);	// pData madla data gpID3D11Buffer_VertexBuffer made janaysathi Unmap karyacha
		...
		gpID3D11DeviceContext->Unmap(gpID3D11Buffer_VertexBuffer_Color, 0);	// pData madla data gpID3D11Buffer_VertexBuffer made janaysathi Unmap karyacha
