...
#define SK_PI 3.1415926535897932

#define SK_STRING "Somshekhar Karle RTR2020-079"
...
int main(void)
{
	...
	const double sk_epsilon = 0.000001;
	...
	printf("SK_PI Macro value = %.10lf\n\n", SK_PI);
	printf("Area Of Circle Of Radius 2 units = %f\n\n", (SK_PI * 2.0f * 2.0f)); //pi * r * r = area of circle of radius 'r'
