...
int main(int argc, char *argv[], char *envp[])
{
	...
	for (inum = 1; inum < argc; inum++) //loop starts from i = 1 because, i = 0 will result in 'argv[i]' = 'argv[0]' which is the name of the program itself i.e :'CommandLineArgumentsApplication.exe'
	{
		printf("%s ", argv[inum]);
	}
	printf("\n\n");
