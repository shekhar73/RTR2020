...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	// code
	if(fopen_s(&gpVendorInfoFile, "VendorInfo.txt", "w") != 0)
	{
...
void Initialize(void)
{
	...
	fprintf(gpVendorInfoFile, "OpenGL VENDOR   : %s\n", glGetString(GL_VENDOR));
	fprintf(gpVendorInfoFile, "OpenGL RENDERER : %s\n", glGetString(GL_RENDERER));
	fprintf(gpVendorInfoFile, "OpenGL VERSION  : %s\n", glGetString(GL_VERSION));
	fprintf(gpVendorInfoFile, "GLSN VERSION    : %s\n", glGetString(GL_SHADING_LANGUAGE_VERSION));
	...
	glGetShaderiv(gVertexShaderObject, GL_COMPILE_STATUS, &iShaderCompiledStats == GL_FALSE);
